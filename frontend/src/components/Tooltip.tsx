...
function getMargin({ margin, arrow }: IStyleProps) {
...
function Arrow(props: IStyleProps) {
  if (props.arrow) {
    return (
      <StyledArrow {...props}>
...
function getArrowMargin(props: IStyleProps) {
...
const ContentOuterContainer = withProps<IStyleProps>(styled.div)`
...
export default class Tooltip extends React.Component<IStyleProps, {}> {
  public render() {
    const {
      children,
      ...otherProps
